...
var _Tconst={
	book_all_type:',般若佛学=A,笔趣阁=B,筆趣閣=B,中医世家=C,草药图鉴=C,恩赐小说=C,国学文摘=D,汉程文学=E,乐魔小说=F,内肉小说=G,人妻小说=H,人文小说=I,啃书小说=J,松鹏小说=K,中华典藏=Z,',
...
function set_doc_title(title,flg) {
    document.title=title;
    if(!flg)my_History();
    if("undefined"!==typeof qsk)qsk.jsAndroid("title:"+title);
}
set_doc_title(document.title,1);
